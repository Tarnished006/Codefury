  ...
  return (
    <div className="min-h-screen bg-white text-black flex flex-col justify-between p-6">
      ...
      <div className="max-w-[1440px] mx-auto w-full flex items-center justify-between">
        ...
        <span className="bracket-label">[ AUTH_SYSTEM_V2 ]</span>
      </div>

      {/* Center card */}
      <div className="w-full max-w-md mx-auto my-12 border border-[#E4E4E7] bg-white p-8">
        <div className="flex items-center justify-between mb-6">
          <span className="bracket-label text-black">[ CONNECT_ID ]</span>
        ...
        <p className="font-mono text-xs text-[#71717A] mb-8">
          Sign in with your Developer ID or initialize a Demo Session.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            <span>{loading ? "AUTHENTICATING..." : "SIGN_IN"}</span>
        ...
        >
          <span>QUICK DEMO (500 FREE CREDITS)</span>
        </button>
      ...
      <footer className="border-t border-[#E4E4E7] py-4 text-center text-xs font-mono text-[#71717A]">
        agentnet // End-to-End Encrypted Auth
      </footer>
    </div>
  );
}